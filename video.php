<html>
    ...
    <body>
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="row">
                    ...
                    <nav class="navbar navbar-default" style="background: #006eff;">
        ...
        <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-10" style="min-height: 50px; background: #006eff; border-radius: 5px;">
                <center>
                    <span style="font-size: 30px; color: white;">Video Gallery</span>
                </center>
            </div>
            <div class="col-md-1"></div>
        </div>
       ...
       <br>
       <div class="row">
           <div class="col-md-4" style="background: blue; min-height: 300px;">
            <video   controls>
              <source  src="movie.mp4" type="video/mp4">
          </video>
        </div>
           <div class="col-md-4" style="background: red; min-height: 300px;"></div>
           <div class="col-md-4" style="background: yellow; min-height: 300px;"></div>
       </div>
        ...
        <br>
            <!--footer section-->
            <div class="row">
                <div class="col-md-12" style="background: #006eff;">
                 <div class="row">
                   <div class="col-md-1"></div>
                   <div class="col-md-3">
                 ...
                 <br>
                 <div class="row">
                   <div class="col-md-12" style="background: #002fff; min-height: 40px;">
