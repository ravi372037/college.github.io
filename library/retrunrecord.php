...
<body>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
              ...
              <div class="row">
                ...
                <div class="col-sm-1"><a href="print.php?$type=returnbook" target="blank"><button  id="print"><i class="fa fa-print" aria-hidden="true"></i> Print</button></a></div>
              </div>
             <br>
                <div class="col-sm-12">
        <?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
        ...
        $tb= "SELECT * FROM `returnbook` WHERE branch='$branch' AND sem='$sem'";
