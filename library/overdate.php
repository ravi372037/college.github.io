...
<body>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4" style="background-color: #0b660b;"> 
                <div class="container-fluid">
                    ...
                    <h1 style="color: white; ">Over Date Detail</h1>
            ...
            <div class="container-fluid">
              ...
              <div class="row">
                ...
                <div class="col-sm-1"><a href="print.php?$type=overdate" target="blank"><button  id="print"><i class="fa fa-print" aria-hidden="true"></i> Print</button></a></div>
              </div>
             <br>
                <div class="col-sm-12">
        <?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
        ...
        $tb= "SELECT * FROM `overdate` WHERE branch='$branch' AND sem='$sem'";
                       ...
                       <thead>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?=$row['bookname']?></td>
                            <td><?=$row['bookno']?></td>
                            <td><?=$Date = date("d-m-Y", strtotime($row['issueedate']))?></td>
                            <td><?=$row['overday']?></td>
